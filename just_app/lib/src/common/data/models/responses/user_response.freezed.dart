...
abstract class $UserResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, String email, String token});
}
...
class _$_UserResponse implements _UserResponse {
  _$_UserResponse(
      {required this.uid, required this.email, required this.token});
  ...
  @override
  String toString() {
    return 'UserResponse(uid: $uid, email: $email, token: $token)';
  }
